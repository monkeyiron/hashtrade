...
hooks:
  ...
  Stop:
    - hooks:
        - type: command
          command: "export SD=\"${CLAUDE_PLUGIN_ROOT:-.agent/get-shit-done}/scripts\"; powershell.exe -NoProfile -ExecutionPolicy Bypass -File \"$SD/check-complete.ps1\" 2>/dev/null || sh \"$SD/check-complete.sh\""
metadata:
  version: "2.33.0"
---
